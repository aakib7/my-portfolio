...
function ContactWithCaptcha() {
  ...
  const handleSendMail = async (e) => {
    ...
    const serviceID = "service_kvzjp53"; // Replace with your actual EmailJS Service ID
    const templateID = "template_zzedcth"; // Replace with your actual EmailJS Template ID
    const publicKey = "pvcZEfvmqpclVeI31"; // Replace with your actual EmailJS Public Key
